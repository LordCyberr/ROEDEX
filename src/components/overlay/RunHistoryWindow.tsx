      ...
      >
        ...
        <div className="flex items-center justify-between p-3 border-b border-white/10 bg-white/[0.02] cursor-grab active:cursor-grabbing">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xs font-black tracking-widest text-white uppercase">Past Runs</h2>
          </div>
          <div className="flex items-center gap-2">
            {runHistory.length > 0 && (
              <button 
        ...
        <div className="flex flex-1 flex-col overflow-hidden bg-black/40 p-2">
              ...
              <AnimatePresence mode="popLayout">
                {runHistory.map((run: any) => {
                  ...
                  return (
                    <motion.div
                      ...
                      key={run.id}
                      className="flex flex-col p-3 rounded-lg bg-white/5 border border-white/[0.02] hover:bg-white/10 transition-colors group"
                    >
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-black/40 rounded p-2 flex flex-col items-center justify-center border border-white/[0.02]">
                ...
                {runHistory.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-10 text-slate-500 gap-2">
                    ...
                    <span className="text-[11px] font-bold tracking-widest uppercase">No Past Runs</span>
                    <span className="text-[9px]">Finish a run to save it to your history.</span>
                  </div>
                )}
              </AnimatePresence>
            </div>
