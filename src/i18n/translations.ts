export const translations = {
  "en": {
    ...
    "settings": {
      ...
      "disclaimer": "ROEDEX is not audited or officially endorsed by Ruyui Studios.",
      "general": "General",
      "uiTheme": "UI Theme",
  ...
  "es": {
    ...
    "settings": {
      ...
      "gameDevelopers": "Desarrolladores del Juego",
      "disclaimer": "ROEDEX no está auditado ni respaldado oficialmente por Ruyui Studios.",
      "general": "General",
      "uiTheme": "Tema UI",
  ...
  "ko": {
    ...
    "settings": {
      ...
      "gameDevelopers": "게임 개발사",
      "disclaimer": "ROEDEX는 Ruyui Studios에 의해 검증(감사)되거나 공식적으로 보증되지 않았습니다.",
      "general": "일반",
      "uiTheme": "UI 테마",
